...
def test_study_analysis_navigation_opens_project_workspace():
    ...
    assert 'href="/projects/{{ project.id }}/workspace">Project workspace</a>' in template
    assert 'href="/projects/{{ project.id }}/workspace/analysis">AI suggestions</a>' in template
...
def test_projects_page_analysis_control_opens_project_workspace():
    ...
    assert 'href="/projects/{{ p.id }}/workspace">Research workspace</a>' in template
    assert 'href="#analysis">Analysis</a>' not in template
