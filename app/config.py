...
class Settings(BaseSettings):
    ...
    # Exactly one selector is required for a production Rivermere import. Both
    # are removed from App Service immediately after the one-time import.
    rivermere_demo_owner_user_id: str | None = None
    rivermere_demo_owner_email: str | None = None
