...
MEANINGFUL_ORGANISATION_MODELS = (
    ...
    (ParticipantPasswordCredential, "participant reusable app credentials"),
    ...
    (ResearchThemeCode, "research theme-code links"),
    ...
    (AnalysisCanvas, "analysis canvases"),
    (AnalysisCanvasNode, "analysis canvas placements"),
