...
const platformPrivacyNoticeDocument = LegalDocument(
  ...
  sections: [
    ...
    LegalSection(
      "Information handled by Citizen Centric",
      [
    ...
    LegalSection(
      "Why Politis Ltd uses information",
      [
...
const accessibilityPolicyDocument = LegalDocument(
  ...
  summary:
      "Our approach to accessible participation and reasonable adjustments.",
  sections: [
    LegalSection("Publication details", [
      "Operator — Politis Ltd (company number 13661766)",
      "Version — 1.1",
    ...
    LegalSection(
      "Getting help or requesting an adjustment",
      [
...
const consentNoticeDocument = LegalDocument(
  ...
  summary:
      "How research participation consent is obtained, recorded and withdrawn.",
  sections: [
    LegalSection("Publication details", [
      "Operator — Politis Ltd (company number 13661766)",
      "Version — 1.1",
